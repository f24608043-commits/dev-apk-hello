...
git remote add origin git@github.com:f24608043-commits/pure-shop-stack.git

# Push to GitHub
git push -u origin main

# Alternative: If you want to use HTTPS instead of SSH
# git remote add origin https://github.com/f24608043-commits/pure-shop-stack.git